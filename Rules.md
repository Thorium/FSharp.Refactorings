...
| ID | Category | Enabled * | API ** | Fires on | Offered fix |
| -- | -- | -- | -- | -- | -- |
...
| FR0019 | Correctness | v | | `override _.Equals(o) = ...` | — |
| FR0020 | Correctness | v | | `type B() as this =<br>    do this.Init()<br>    abstract Init: unit -> unit` | — |
...
| FR0028 | Performance | v | | `for c in customers do for o in db.Orders do use c o` | — |
...
| FR0032 | Correctness | v | | `type T() =<br>    let stream = new FileStream(...)` | — |
...
| FR0046 | Correctness | v | | `lock "cache" (fun () -> ...)` | — |
| FR0047 | Correctness | v | | `let s = new FileStream(...)<br>interface IDisposable with<br>    member _.Dispose() = ()` | — |
| FR0048 | Correctness | v | | `String.Format("{0} of {1}", x)` | — |
| FR0049 | Correctness | v | | `task { let x = t.Result in use x }` | `task { let! x = t in use x }` |
...
| FR0055 | Correctness | v | | `try work () with _ -> ()` | — |
| FR0057 | Cosmetic | v | | `/// <param name="value">The value.</param><br>let scale value factor = ...` | — |
...
| FR0061 | Correctness | v | | `let scale value factor = invalidArg "facotr" "zero factor"` | — |
| FR0062 | Correctness | v | | `let mutable counter = 0<br>let bump () = counter <- counter + 1` | — |
| FR0063 | Correctness | v | | `try work () finally failwith "cleanup"` | — |
| FR0064 | Correctness | v | | `raise (NullReferenceException())` | — |
| FR0065 | Correctness | v | | `use md5 = MD5.Create()` | — |
| FR0066 | Correctness | v | | `cmd.CommandText <- $"SELECT * FROM t WHERE id={id}"` | — |
...
| FR0079 | Performance | v | | `Task.WhenAll [\| t \|]` | — |
...
| FR0105 | Correctness | v | | `let due = balance + 2_000_000_000` | — |
...
| FR0122 | Correctness | v | | `Regex("(unclosed")` | — |
...
| FR0126 | Correctness | v | | `Process.Start("cmd", $"/c {input}")` | — |
| FR0127 | Correctness | v | | `let key = "sk-ant-api03-..."` | — |
